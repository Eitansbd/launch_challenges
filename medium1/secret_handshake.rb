...
and those who dont. You and your fellow cohort of those in the "know" when
...
class SecretHandshake
  ...
  def initialize(num)
    @num = num.is_a?(Integer) ? num.to_s(2).chars.reverse : num.chars.reverse
  end

  def commands
    shake = []
    @num.each_with_index do |val, index|
      break shake.reverse! if index == 4
      shake << COMMANDS[index] if val == '1'
    end
